...
const colors = {
    ...
    blue: '#2121DE',   // Pac-man wall blue
    red: '#FF0000',    // Blinky red
    cyan: '#00FFFF'
};

const pixelSize = 25; // Size of our "8-bit blocks"
let frame = 0;
...
function drawScene() {
    ...
    // Animate cable going up and down slowly
    const cableLength = 8 + Math.sin(frame * 0.02) * 4; 
    
    for (let y = 6; y < 6 + cableLength; y++) {
        drawPixel(cableX, y, '#555555'); // Grey cable
    }
    // Payload (A blue block being lifted)
    drawPixel(cableX, Math.floor(6 + cableLength), colors.blue);

    // 3. Draw The Worker
    // Worker moves along the ground
